        ...
        <section className='auth-form'>
            <header className='flex flex-col gap-5 md:gap-8'>
                ...
                <div className='flex flex-col gap-1 md:gap-3'>
                    <h1 className='text-24 lg:texxt-36 font-semibold text-gray-900'>
                        {user
                            ? "Link Account"
                            : type === "sign-in"
                                ? "Sign In"
                        ...
                        <p className='text-16 font-norma text-gray-600'>
                            {user
                                ? "Link your account to MyntPay"
