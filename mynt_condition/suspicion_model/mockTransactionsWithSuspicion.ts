...
export interface SuspiciousTransaction extends Transaction {
...
export async function fetchTransactionsFromPython(): Promise<SuspiciousTransaction[]> {
  try {
    ...
    return mockTransactionsWithSuspicion; // Fallback to mock data
  }
}

export const mockTransactionsWithSuspicion: SuspiciousTransaction[] = [
  {
    id: "1",
    name: "Grocery Store",
